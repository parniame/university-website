<?php
    ...
    $sql = "SELECT ID,courseName
    ,professorName,classDay,classTime
            FROM courses"
  ...
  <body>
    <header>
      ...
      <nav class="subtopnav">
        ...
        <a
          href="http://localhost:80/university-website/manager.php"
          class="item-nav right"
        >
          صفحه &zwnj;تعریف دروس</a
        >
      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <form
          method="post"
          action="http://localhost:80/university-website/php/delete_manager.php"
          id="insertCourse">
