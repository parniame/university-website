...
<html lang="fa" dir="rtl">
  ...
  <body>
    ...
    <?php
      ...
      <!-- <a
        href="http://localhost:80/university-website/sign-up.html"
        class="d-block m-3 text-decoration-none link-danger text-center"
        >عضویت کاربر</a
      >
      <p class="d-block m-3 text-danger text-center">
        مدیر برای ثبت نام با واحد پشتیبانی تماس بگیرد!
      </p> --> 
    </main>
    <footer>
